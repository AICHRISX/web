...
* @Last Modified time: 2019-10-13 14:57:12
*/
...
db.once('open',()=>{
	...
	*/
	/*
	UserModel.updateMany({age:{$gt:140}},{$set:{name:"Chris"}},(err,result)=>{
		if(err){
			console.log('updateOne user error:',err)
		}else{
			console.log(result)
	...
	*/
/*
	UserModel.updateMany({age:{$gt:140}},{name:"Ad"},(err,result)=>{
		if(err){
			console.log('updateOne user error:',err)
		}else{
			console.log(result)
...
UserModel.updateOne({age:{$gt:140}},{name:"Chris"},(err,result)=>{
		if(err){
			console.log('updateOne user error:',err)
		}else{
			console.log(result)
